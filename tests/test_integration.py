...
class TestSupabaseIntegration:
    ...
    def test_insertar_y_eliminar_gasto(self):
        ...
        from app.database import insertar_gasto, eliminar_gasto, obtener_gasto_por_id
...
class TestRedisIntegration:
    ...
    def test_guardar_y_recuperar_mensaje(self):
        ...
        from app.memory import save_message, get_conversation_history, clear_conversation_history
...
class TestGoogleSheetsIntegration:
    ...
    def setup(self):
        ...
        if not os.path.exists(settings.google_sheets_credentials_path):
            pytest.skip(f"Archivo de credenciales no encontrado: {settings.google_sheets_credentials_path}")
