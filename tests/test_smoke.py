...
class TestGoogleSheetsSmoke:
    ...
    def test_google_sheets_configurado(self):
        ...
        assert settings.google_sheets_spreadsheet_id, "GOOGLE_SHEETS_SPREADSHEET_ID no está configurado"
        assert settings.google_sheets_credentials_path, "GOOGLE_SHEETS_CREDENTIALS_PATH no está configurado"
